...
const Contact = () => {
  ...
  return (
    <div
      className="flex flex-col-reverse lg:flex-row gap-x-10 px-10 md:px-32 lg:p-32 items-start justify-center min-h-screen bg-base-100 hero bg-cover bg-no-repeat bg-center"
